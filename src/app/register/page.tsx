  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <video ref={videoRef} className="absolute inset-0 w-full h-full object-cover" autoPlay loop muted playsInline>
        <source
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Flowing+Neon+Curve+Lines_1-RreOUtWwOjjOZieYwW15alf86D2OYF.mp4"
          type="video/mp4"
        />
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          >
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold tracking-tight">Join AntiprophetAI</h1>
              <p className="mt-2 text-gray-600">Create Your AntiprophetAI Account</p>
            </div>
