...
// Sample user data
const users: User[] = [
  { id: 1, name: "Alice Johnson", username: "alice_j", avatar: "/placeholder.svg?height=64&width=64" },
  { id: 2, name: "Bob Smith", username: "bob_s", avatar: "/placeholder.svg?height=64&width=64" },
  { id: 3, name: "Charlie Brown", username: "charlie_b", avatar: "/placeholder.svg?height=64&width=64" },
  { id: 4, name: "Diana Ross", username: "diana_r", avatar: "/placeholder.svg?height=64&width=64" },
]
...
const generateInstagramData = (count: number, userId: number): InstagramData[] => {
...
const generateChartData = (): DailyView[] => {
...
export default function AdminDashboard() {
  ...
  const instagramData = useMemo<InstagramData[]>(() => generateInstagramData(100, selectedUser.id), [selectedUser.id])
  ...
  const filteredAndSortedVideos = useMemo<InstagramData[]>(() => {
  ...
  const handleSortChange = (value: string) => {
    if (value === sortBy) {
      ...
      setSortOrder(value === "date" ? "desc" : "desc") // Default to newest first for date sorting
    }
  }
      ...
      <div className="flex-1 p-10 relative z-10 overflow-y-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-white/70 text-lg mt-2">
            Monitoring {selectedUser.name}'s (@{selectedUser.username}) Instagram engagement and growth
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Total number of video views for {selectedUser.name}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Total number of video likes for {selectedUser.name}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Total number of video comments for {selectedUser.name}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Total number of video shares for {selectedUser.name}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Select
                ...
                onValueChange={(value: string) => setPerformanceFilter(value as PerformanceFilter)}
              >
            ...
            {isLoading ? (
              <div className="space-y-4">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="h-12 w-full bg-gray-700" />
                ))}
              </div>
            ) : (
              <Table>
